#!/usr/bin/env bash
# ============================================================
# 00_download_gharchive_2024q1.sh
# Download GH Archive hourly files (2024-01-01 to 2024-03-31)
# and stream them directly into HDFS via stdin pipe.
#
# Usage (run on nyu-dataproc-m):
#   nohup bash /tmp/00_download_gharchive_2024q1.sh > /tmp/download_2024q1.log 2>&1 &
#
# Files land at:
#   /user/jl17797_nyu_edu/oss_pulse/source/gharchive_2024q1/YYYY-MM-DD-H.json.gz
# ============================================================

set -euo pipefail

HDFS_DEST="/user/jl17797_nyu_edu/oss_pulse/source/gharchive_2024q1"
...
EXISTING_LIST="/tmp/gharchive_2024q1_existing.txt"
...
echo "=== 2024 Q1 download complete ==="
