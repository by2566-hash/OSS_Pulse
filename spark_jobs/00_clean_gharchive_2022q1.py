"""
Job 00_clean_2022q1: Clean GH Archive 2022 Q1 data
----------------------------------------------------
Input:  /user/jl17797_nyu_edu/oss_pulse/source/gharchive_2022q1/
Output: /user/jl17797_nyu_edu/oss_pulse/cleaned/gharchive_2022q1/
        (same schema as by2566's cleaned/gharchive/2025/)

Purpose: Provide pre-coding-agent baseline for era comparison (Job 08).

Run:
  spark-submit /tmp/00_clean_gharchive_2022q1.py
"""
...
spark = SparkSession.builder.appName("00_CleanGHArchive2022Q1").getOrCreate()
...
OUT = "/user/jl17797_nyu_edu/oss_pulse/cleaned/gharchive_2022q1"
